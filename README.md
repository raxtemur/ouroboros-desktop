...
Older releases are preserved in Git tags and GitHub releases. The 5.2.0, 5.2.3, 5.3.x release-candidate rows and former `4.0.0` row are rolled off to respect the P9 changelog cap; their full bodies remain at their git tags.
